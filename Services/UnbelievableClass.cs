...
public class UnbelievableClass
{
    ...
    private void CircularBufferDemo()
    {
    ...
    private void PrintBuffer(CircularBuffer<int> buffer)
    {
    ...
    private async Task<bool[]> GetAllSite()
    {
    ...
    private async Task<bool> HttpGetAsync(string requestUri)
    {
        try
        {
    ...
    private async Task<HashSet<string>> UploadAsync(
    ...
    private void ParallelEnumerable()
    {
    ...
    private string Abbreviate(decimal number)
    {
